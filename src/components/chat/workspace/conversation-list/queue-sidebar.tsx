...
/** Sidebar de filas: abas Aguardando | Em atendimento | Pausados. */
export function QueueSidebar({
  ...
  /** Incrementa pra forçar reload dos counts das outras abas. */
  countsTick?: number;
}) {
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-xs text-[var(--color-muted)]">
                  {s.last_body ||
                    (s.routing_reason === "vip_deal" ? "VIP · fila prioritária" : "—")}
                </p>
